        ...
        <>
            <footer className="footer p-3 bg-black text-neutral-content">
                ...
                <div className='ml-96'>
                    ...
                    <a className="mt-[-7px]">사업자등록번호:12343-456-1348857</a>
                    <a className="mt-[-7px]">공용메일@gmail.com</a>
                    <span className="link link-hover mt-3">COPYRIGHT © 2023 TEA파티. ALL RIGHTS RESERVED</span>
                </div>
            </footer>
